            ...
            <div class="col-lg-6">
                <div class="about-content-box pt-0">
                    <div class="section-heading">
                        ...
                        <h2 class="section__title line-height-50">The leading global marketplace for learning and instruction</h2>
                    ...
                    <ul class="list-items">
                        <li><i class="la la-check-circle"></i> Online Courses with full discount systems.</li>
                        <li><i class="la la-check-circle"></i> Online Certificates which can be used worldwide.</li>
                        <li><i class="la la-check-circle"></i> An online leadership development program at Aduca.</li>
                    </ul>
                </div>
            </div><!-- end col-lg-6 -->
            <div class="col-lg-6">
                ...
                <div class="col-lg-4 column-td-half">
                    <div class="post-card post-card-layout-2">
                        <div class="post-card-content">
                            ...
                            <h2 class="widget-title mt-4 mb-2">Personalized learning</h2>
                ...
                <div class="col-lg-4 column-td-half">
                    <div class="post-card post-card-layout-2">
                        <div class="post-card-content">
                            ...
                            <h2 class="widget-title mt-4 mb-2">Trusted content</h2>
                            <p>Created by experts, Coursector library of trusted practice and lessons covers math, science, and more.</p>
                        </div><!-- end post-card-content -->
                    </div>
                </div><!-- end col-lg-4 -->
                <div class="col-lg-4 column-td-half">
                    <div class="post-card post-card-layout-2 mb-3">
                        <div class="post-card-content">
                            ...
                            <h2 class="widget-title mt-4 mb-2">Empower teachers</h2>
                            <p>With Coursector, teachers can identify gaps in their students’ understanding, tailor instruction</p>
                        </div><!-- end post-card-content -->
                    </div>
                </div><!-- end col-lg-4 -->
                <div class="col-lg-12">
                    <p>Want to join with us? See our<a href="#" class="primary-color-2"> open positions</a></p>
                </div>
            </div><!-- end row -->
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="about-content-box padding-left-60px">
                    <div class="section-heading">
                        <h5 class="section__meta">our goal</h5>
                        <h2 class="section__title">Our Mission</h2>
                        <span class="section-divider"></span>
                        <p class="section__desc mb-3">
                            We’re not one of those companies. We are rethinking education from the bottom up.
                            The web has rethought nearly everything - commerce, social networking, healthcare,
                            and more. We are building the education the world needs - the first truly net native education.
                            We take more cues from modern
                            tech innovators in creating an engaging educational experience than we do from the classroom.
                        </p>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="about-content-box">
                    <div class="section-heading">
                        <h5 class="section__meta">our journey</h5>
                        ...
                        <p class="section__desc">Sed ut perspiciatis unde omnis iste natus error sit voluptatem eaque ipsa quae ab illo Maecenas quis
                            <br> consequat Consectetur Adipiscing Elit, Sed Do Eiusmod Tempor Incididunt Ut Labore Et Dolore Magna Aliqua.
                            <br> Ut Enim Ad Minim Veniam, Quis Nostrud Exercitation Ullamco Laboris Nisi Ut Aliquip Ex Ea Commodo Consequat.
                            <br> Duis Aute Irure Dolor In Reprehenderit In Voluptate Velit Esse Cillum Dolore</p>
                    </div><!-- end section-heading -->
                </div>
            </div><!-- end col-lg-12 -->
        </div><!-- end row -->
                 ...
                 <div class="col-lg-4 column-td-half">
                    <div class="story-img-item">
                        ...
                        <div class="story-video">
                            <a href="#" class="btn-text video-play-btn" data-fancybox="video" data-src="https://www.youtube.com/watch?v=VqIp_sO8OVQ" data-speed="700">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="section-heading text-center">
                    ...
                    <h2 class="section__title">Meet Our Leaderships</h2>
                    <span class="section-divider"></span>
                </div><!-- end section-heading -->
            </div><!-- end col-lg-12 -->
        </div><!-- end row -->
            ...
            <div class="row">
                <div class="col-lg-3 column-td-half">
                    <div class="team-item team-layout-2">
                        ...
                        <div class="team-detail">
                            <h3 class="team__title">alex smith</h3>
                            <p class="team__meta">Founder and CEO</p>
                ...
                <div class="col-lg-3 column-td-half">
                    <div class="team-item team-layout-2">
                        ...
                        <div class="team-detail">
                            <h3 class="team__title">rose taylor</h3>
                            <p class="team__meta">President and co-CEO</p>
                ...
                <div class="col-lg-3 column-td-half">
                    <div class="team-item team-layout-2">
                        ...
                        <div class="team-detail">
                            <h3 class="team__title">jef collin</h3>
                            <p class="team__meta">Chief Technology Officer</p>
                ...
                <div class="col-lg-3 column-td-half">
                    <div class="team-item team-layout-2">
                        ...
                        <div class="team-detail">
                            <h3 class="team__title">mike hardson</h3>
                            <p class="team__meta">Chief Marketing Officer</p>
                            <a href="javascript:void(0)" class="theme-btn theme-btn-light" data-toggle="modal" data-target=".team-modal-form" data-whatever="Mike Hardson">read his bio</a>
                        </div>
                    </div><!-- end team-item -->
                </div><!-- end col-lg-3 -->
                <div class="col-lg-3 column-td-half">
                    <div class="team-item team-layout-2">
                        ...
                        <div class="team-detail">
                            ...
                            <p class="team__meta">Vice President of Product</p>
                            <a href="javascript:void(0)" class="theme-btn theme-btn-light" data-toggle="modal" data-target=".team-modal-form" data-whatever="Jhon Smith">read his bio</a>
                        </div>
                    </div><!-- end team-item -->
                </div><!-- end col-lg-3 -->
                <div class="col-lg-3 column-td-half">
                    <div class="team-item team-layout-2">
                        ...
                        <div class="team-detail">
                            <h3 class="team__title">kevin martin</h3>
                            <p class="team__meta">Vice President of Services</p>
                ...
                <div class="col-lg-3 column-td-half">
                    <div class="team-item team-layout-2">
                        ...
                        <div class="team-detail">
                            <h3 class="team__title">Tisham Elerdy</h3>
                            <p class="team__meta">VP, Operations</p>
                            <a href="javascript:void(0)" class="theme-btn theme-btn-light" data-toggle="modal" data-target=".team-modal-form" data-whatever="Tisham Elerdy">read his bio</a>
                        </div>
                    </div><!-- end team-item -->
                </div><!-- end col-lg-3 -->
                <div class="col-lg-3 column-td-half">
                    <div class="team-item team-layout-2">
                        ...
                        <div class="team-detail">
                            <h3 class="team__title">Alper Doein</h3>
                            <p class="team__meta">Chief Financial Officer</p>
                            <a href="javascript:void(0)" class="theme-btn theme-btn-light" data-toggle="modal" data-target=".team-modal-form" data-whatever="Alper Doein">read his bio</a>
                        </div>
                    </div><!-- end team-item -->
                </div><!-- end col-lg-3 -->
            </div><!-- end row -->
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="section-heading">
                    ...
                    <h2 class="section__title">From the Aduca community</h2>
                    <span class="section-divider"></span>
            ...
            <div class="col-lg-8">
                <div class="testimonial-subtitle pb-3">
                    <h3 class="widget-title font-weight-medium">30+ million people are already learning on Aduca</h3>
                </div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-5">
                <div class="btn-box text-right">
                    <a href="#" class="theme-btn">Tech on aduca</a>
                </div><!-- end btn-box-->
            </div><!-- end col-lg-5 -->
        </div><!-- end row -->
    </div><!-- end container -->
        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="about-content-box padding-right-50px">
                    ...
                    <div class="btn-box">
                        <a href="#" class="theme-btn">join with our team</a>
                    </div>
                </div>
            </div><!-- end col-lg-6 -->
            <div class="col-lg-6">
